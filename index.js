...
*/
const A187 = '👾RUBYCLOWNBOT👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/danizx_666'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] RUBYCLOWN ready scan now!`);
});
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @danizx_666`)
})
...
conn.sendMessage(id, ' *Owner RUBYCLOWN wa.me/+6282322427684* ' ,MessageType.text);
}
else if (text == '#creator'){
conn.sendMessage(id, ' *Creator RUBYCLOWN wa.me/+6282322427684* ' ,MessageType.text);
}
else if (text == 'Pagi'){
